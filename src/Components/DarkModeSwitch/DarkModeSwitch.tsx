...
export const DarkModeSwitch = styled((props: SwitchProps) => (
  ...
  "& .MuiSwitch-track": {
    ...
    backgroundColor: theme.palette.primary.light,
    opacity: 1,
    boxShadow: "inset 10px 10px 15px 0px rgba(0, 0, 0, 0.5)",
    ...
    "&:before": {
      backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path fill="${encodeURIComponent(
    ...
    "&:after": {
      backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="18" width="18" viewBox="0 0 18 18"><path fill="${encodeURIComponent(
        "#e0e0e0"
      )}" d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z" /><path fill="${encodeURIComponent(
        "#e0e0e0"
